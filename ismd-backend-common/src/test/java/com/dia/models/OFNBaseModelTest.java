...
class OFNBaseModelTest {
    ...
    void testCreateBaseModel_classesWithLabels() {
        ...
        OntClass pojemClass = ontModel.getOntClass(NS + POJEM);
        ...
        assertEquals(NS + POJEM, pojemClass.getURI(), "URI třídy 'pojem' musí odpovídat NS+TYP_POJEM");

        // Ověření, že třída 'vlastnost' existuje, má správný label a je podtřídou 'pojem'
        OntClass vlastnostClass = ontModel.getOntClass(NS + VLASTNOST);
        ...
        OntClass vztahClass = ontModel.getOntClass(NS + VZTAH);
        ...
        OntClass tridaClass = ontModel.getOntClass(NS + TRIDA);
        ...
        OntClass datovyTyp = ontModel.getOntClass(NS + DATOVY_TYP);
        ...
        OntClass typSubjektuClass = ontModel.getOntClass(NS + TSP);
        ...
        OntClass typObjektuClass = ontModel.getOntClass(NS + TOP);
        ...
        OntClass verejnyUdajClass = ontModel.getOntClass(NS + VEREJNY_UDAJ);
        ...
        OntClass neverejnyUdajClass = ontModel.getOntClass(NS + NEVEREJNY_UDAJ);
    ...
    void testCreateBaseModel_properties() {
        ...
        OntProperty nazevProp = ontModel.getOntProperty(NS + NAZEV);
        ...
        assertEquals(NS + NAZEV, nazevProp.getURI(), "URI vlastnosti 'nazev' musí odpovídat NS+LABEL_NAZEV");

        // Ověření, že vlastnost 'popis' existuje, má správný label, doménu TYP_POJEM a rozsah XSD:string
        OntProperty popisProp = ontModel.getOntProperty(NS + POPIS);
        ...
        OntProperty definiceProp = ontModel.getOntProperty(NS + DEFINICE);
        ...
        OntProperty zdrojProp = ontModel.getOntProperty(NS + ZDROJ);
        ...
        OntProperty jeSdilenVPpdfProp = ontModel.getOntProperty(NS + JE_PPDF);
        ...
        OntProperty agendaProp = ontModel.getOntProperty(NS + AGENDA);
        ...
        OntProperty aisProp = ontModel.getOntProperty(NS + AIS);
        ...
        OntProperty ustanoveniProp = ontModel.getOntProperty(NS + USTANOVENI_NEVEREJNOST);
        ...
        OntProperty definicniOborProp = ontModel.getOntProperty(NS + DEFINICNI_OBOR);
        ...
        OntProperty oborHodnotProp = ontModel.getOntProperty(NS + OBOR_HODNOT);
        ...
        OntProperty nadrazenaTrida = ontModel.getOntProperty(NS + NADRAZENA_TRIDA);
        ...
        OntProperty souvisejiciUstanoveni = ontModel.getOntProperty(NS + SUPP);
        ...
        OntProperty zpusobSdileniProp = ontModel.getOntProperty(NS + ZPUSOB_SDILENI);
        ...
        OntProperty zpusobZiskaniProp = ontModel.getOntProperty(NS + ZPUSOB_ZISKANI);
        ...
        // Ověření, že property 'typObsahuProp' existuje a má správný label, bez domény a rozsahu
        OntProperty typObsahuProp = ontModel.getOntProperty(NS + TYP_OBSAHU);
    ...
    void testCreateBaseModel_Isolated() throws Exception {
        ...
        OntClass pojemClass = freshOntModel.getOntClass(NS + POJEM);
