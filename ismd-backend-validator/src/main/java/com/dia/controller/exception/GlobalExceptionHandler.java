...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ConversionResponseDto> handleUnsupportedMediaType(HttpMediaTypeNotSupportedException e) {
        ...
        ConversionResponseDto response = ConversionResponseDto.error("Nepodporovaný typ požadavku (Content-Type). Požadováno multipart/form-data.");
    ...
    public ResponseEntity<ConversionResponseDto> handleValidationErrors(MethodArgumentNotValidException e) {
        ...
        ConversionResponseDto response = ConversionResponseDto.error("Nepodporovaný vstupní formát.");
    ...
    public ResponseEntity<ConversionResponseDto> handleGenericException(Exception e) {
        ...
        ConversionResponseDto response = ConversionResponseDto.error("Došlo k neočekávané chybě.");
        return new ResponseEntity<>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}